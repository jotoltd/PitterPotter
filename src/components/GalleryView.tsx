...
export default function GalleryView() {
 ...
 <span className="text-xs tracking-widest text-[#1B2D3C] font-black uppercase block">Artisan Exhibition</span>
 <h1 className="font-heading text-4xl md:text-5xl font-black text-[#1B2D3C] tracking-tight">Studio Gallery</h1>
