  ...
  return (
    <div id="contact-view" className="space-y-16 pb-20 pt-6">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 text-center space-y-4">
        <h1 className="font-heading text-4xl md:text-5xl font-black italic tracking-tight text-[#1B2D3C]"><EditableText contentKey="contact_title" page="contact" defaultValue="Book a Session" adminMode={adminMode} className="font-heading text-4xl md:text-5xl italic text-[#1B2D3C]" /></h1>
      </div>
