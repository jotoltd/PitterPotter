...
export default function HomeView({ setCurrentPage, adminMode = false }: HomeViewProps) {
 ...
 >
 <EditableText contentKey="hero_book_button" page="home" defaultValue="Book a Session" adminMode={adminMode} className="text-sm tracking-wide" />
 </button>
 <button
 ...
 className="px-7 py-3.5 bg-white text-[#1B2D3C] text-sm tracking-wide border border-[#DBE7E4]/30 hover:border-[#DBE7E4] transition-all cursor-pointer"
 >
 <EditableText contentKey="hero_contact_button" page="home" defaultValue="Contact Us" adminMode={adminMode} className="text-sm tracking-wide" />
 </button>
 </div>
 </motion.div>
 </div>
