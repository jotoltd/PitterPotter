...
export default function App() {
  ...
  const renderCurrentView = () => {
    switch (currentPage) {
      ...
      case 'parties':
        return <PartiesView setCurrentPage={setCurrentPage} setPartyPreset={handlePartyPreset} />;
      case 'pricing':
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F4F8] text-[#1B2D3C] selection:bg-[#74919e]/15 selection:text-[#74919e] border-4 md:border-8 border-[#74919e] transition-all duration-300">
      {/* Splash Screen */}
      <AnimatePresence>
        {showSplash && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-[#F0F4F8] flex items-center justify-center"
          >
            <motion.img
              src={Images.logo}
              alt="Pitter Potter"
